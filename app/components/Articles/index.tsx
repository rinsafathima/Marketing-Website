...
const postData: DataType[] = [
    {
        time: "See",
        heading: 'Regular Diet',
        heading2: 'Healthy Eating Habits',
    ...
    },
    {
        time: "See",
        heading: 'Vegan Diet',
        heading2: 'Plant-Based Nutrition',
        name: "Published on Startupon",
        date: 'August 19, 2021',
            ...
            <div className="bg-lightgrey py-20" id="blog-section">
                <div className='mx-auto max-w-7xl sm:py-4 lg:px-8 '>
                    ...
                    <div className="text-center">
                        <h3 className="text-blue text-lg font-normal tracking-widest">Diet Types</h3>
                        <h3 className="text-4xl sm:text-6xl font-bold">Design your dream diet</h3>
                    </div>
